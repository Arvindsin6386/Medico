                                ...
                                <tr class="medicine-row" data-name="{{ strtolower($medicine->name) }}"
                                    ...
                                    <td class="py-3">
                                        ...
                                        @elseif($medicine->stock <= 10)
                                            <span class="fw-bold" style="color:#D85A30;">
                                                {{ $medicine->stock }} ⚠
                                            </span>
                                        @else
                                            <span class="fw-bold" style="color:#085041;">
                                                {{ $medicine->stock }}
                                            </span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="py-3">
                                        @if ($medicine->expiry_date)
                                            @php
                                                ...
                                                $expiring = !$expired && $expiry->diffInDays(now()) <= 30;
                                            @endphp
                                            @if ($expired)
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="date" name="manufacture_date"
                                                                class="form-control"
                                                                value="{{ $medicine->manufacture_date?->format('Y-m-d') }}">
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="date" name="expiry_date" class="form-control"
                                                                value="{{ $medicine->expiry_date?->format('Y-m-d') }}">
                                                        </div>
    ...
    <script>
        ...
        function filterTable() {
            ...
            document.querySelectorAll('.medicine-row').forEach(row => {
                ...
                let matchStock = true;
                if (stock === 'in') matchStock = qty > 10;
                if (stock === 'low') matchStock = qty >= 1 && qty <= 10;
                if (stock === 'out') matchStock = qty === 0;
