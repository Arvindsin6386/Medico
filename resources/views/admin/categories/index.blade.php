...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h5 class="fw-bold mb-0" style="color:#0d2b24;">Manage Categories</h5>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-4 col-6">
                <div class="p-3 rounded-3" style="background:#e1f5ee; border:1px solid #9FE1CB;">
                    <p class="mb-1 text-muted" style="font-size:12px;">Total Categories</p>
                    <h4 class="fw-bold mb-0" style="color:#085041;">{{ $categories->count() }}</h4>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0" style="font-size:13px;">
                        ...
                        <thead style="background:#f0f4f3;">
                            <tr>
                                ...
                                <th class="py-3" style="font-size:11px; color:#6b9e93;">Subcategories</th>
